...
!   FFT Plan physique ---> plan spectral
  ...
  call drcfts (ft, nx, jump, ny, nx+2, iopt, ierr)
...
!   FFT Plan physique ---> plan spectral
  ...
  call drcfts (ft, ny, nx, nx, jump, iopt, ierr)
...
!   FFT Plan physique ---> plan spectral
  ...
  call zrc2ft (ft, nx, ny, nx+1, iopt, ierr)
...
!   FFT Plan physique ---> plan spectral
  ...
  call drcfts (ft, L, jump, n, L+2, iopt, ierr)
